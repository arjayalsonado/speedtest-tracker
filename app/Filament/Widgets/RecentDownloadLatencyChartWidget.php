        ...
        return [
            'datasets' => [
                [
                    ...
                    'data' => $results->map(fn ($item) => $item->status === ResultStatus::Completed ? $item->download_latency_iqm : null),
                ...
                [
                    ...
                    'data' => $results->map(fn ($item) => $item->status === ResultStatus::Completed ? $item->download_latency_high : null),
                ...
                [
                    ...
                    'data' => $results->map(fn ($item) => $item->status === ResultStatus::Completed ? $item->download_latency_low : null),
